...
if (isset($_POST['insert-kelas'])) {
 	...
 	$insertkelas = mysqli_query($con,"INSERT INTO kelas VALUES ('$id','$kelas','') ");
 	if ($insertkelas) {
 	...
 	$insertsekolah 	= "INSERT INTO sekolah VALUES ('$id','$sekolah','$tlpn','$alamat','$foto')";
	$insertsekolah2 = mysqli_query($con,$insertsekolah);
 	...
 	$insertsiswa 	= "INSERT INTO siswa VALUES ('$nis','$siswa','$tlpn','$email','$alamat','$foto','$jenkel','')";
