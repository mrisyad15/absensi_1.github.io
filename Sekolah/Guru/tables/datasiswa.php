...
<div class="span9">
                    <div class="content">
                        <div class="module">
                            ...
                            <?php 
                              $tampil  = mysqli_query($con,"SELECT * FROM siswa JOIN kelas ON siswa.id_kelas = kelas.id_kelas ORDER BY nis ASC");
                                        ...
                                        <div class="media user">
                                            ...
                                            <div class="media-body">
                                                <h3 class="media-title">
                                                    <?php echo $row['nis']; ?> |  <?php echo $row['nama_siswa']; ?><!--  <input name="checked_id[]" type="checkbox" class="checkbox" value="<?php echo $row["nis"]; ?>" style="float: right" > -->
                                                </h3>
                                                <p>
                                                    <small class="muted"><?php echo $row['email'] ?><br>
                                                        <?php echo $row['jenis_kelamin'] ?><br>
